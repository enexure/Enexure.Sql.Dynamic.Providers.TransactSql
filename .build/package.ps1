...
$BasePath = "$SolutionDir\Enexure.Sql.Dynamic.Providers.TransactSql"
...
msbuild "Enexure.Sql.Dynamic.Providers.TransactSql.sln" /property:Configuration=Release

#-BasePath $BasePath
$ProjectFile = "$BasePath\Enexure.Sql.Dynamic.Providers.TransactSql.csproj"
